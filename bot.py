...
def gold_signal(message):
    ...
    # NOTE: no "Trade" button here anymore - the old PocketOption link was for
    # binary options (fixed expiry, Call/Put), which doesn't match this MT5-style
    # signal (Entry/SL/TP, no expiry). Add your own MT5 broker link/deep-link
    # here if you have one, e.g.:
    # markup = telebot.types.InlineKeyboardMarkup()
    # markup.add(telebot.types.InlineKeyboardButton("Open in MT5", url="YOUR_BROKER_LINK"))
